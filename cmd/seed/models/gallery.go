...
func SeedGallery(db *gorm.DB) error {
	...
	galleries := []gallery.Gallery{
		...
		},
		{
			...
			CoverImage:  "https://images.unsplash.com/photo-1504004030892-d06adf9ffbcf?q=80&w=1470&auto=format&fit=crop&w=800&q=80",
			Status:      media.MediaStatusPublished,
		...
		},
		{
			...
			Category:    media.SocialEvent,
			CoverImage:  "https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?q=80&w=1470&auto=format&fit=crop&w=800&q=80",
