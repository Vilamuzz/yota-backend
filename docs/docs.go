...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/ambulance/{id}/history/{session_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/ambulance/{id}/tracking/start": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/ambulance/{id}/tracking/stop": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
