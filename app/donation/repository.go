...
type Repository interface {
	FetchAllDonations(ctx context.Context, options map[string]interface{}) ([]Donation, error)
	FetchDonationByID(ctx context.Context, id string) (*Donation, error)
...
func (r *repository) FetchAllDonations(ctx context.Context, options map[string]interface{}) ([]Donation, error) {
...
func (r *repository) FetchDonationByID(ctx context.Context, id string) (*Donation, error) {
